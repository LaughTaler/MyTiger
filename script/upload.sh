...
# 定义源目录和目标目录
SRC_DIR=~/tiger
DEST_DIR=~/tiger/libtiger/libtiger/linux/x86_64
CONANFILE_DEST_DIR=~/tiger/libtiger

# 要复制的文件夹列表
FOLDERS=("release/lib" "release/bin" "release/include" "debug/lib" "debug/include" "debug/bin")
...
# else
#     echo "conanfile.py does not exist in $CONANFILE_SRC"
# fi
...
# 构建完整的指令
command="/home/gitlab-runner/anaconda3/envs/conan/bin/conan remove libtiger/${version} -c"
...
command2='/home/gitlab-runner/anaconda3/envs/conan/bin/conan export-pkg . -s os='Linux' -s arch='x86_64''

# 执行指令
echo "执行指令: ${command2}"
${command2}

command3="/home/gitlab-runner/anaconda3/envs/conan/bin/conan remove libtiger/${version} -c -r=lab"

# 执行指令
echo "执行指令: ${command3}"
${command3}

command4="/home/gitlab-runner/anaconda3/envs/conan/bin/conan upload libtiger/${version} -r=lab"
